...
const mockRecipe: Recipe = {
  ...
  ingredients: [
    { id: uuidv4(), name: "All-purpose flour", amount: 2.25, unit: "cup", notes: "sifted", position: 0 },
    { id: uuidv4(), name: "Baking soda", amount: 1, unit: "tsp", notes: "", position: 1 },
    { id: uuidv4(), name: "Salt", amount: 1, unit: "tsp", notes: "", position: 2 },
    { id: uuidv4(), name: "Butter", amount: 1, unit: "cup", notes: "softened", position: 3 },
    { id: uuidv4(), name: "Brown sugar", amount: 0.75, unit: "cup", notes: "packed", position: 4 },
    { id: uuidv4(), name: "White sugar", amount: 0.75, unit: "cup", notes: "", position: 5 },
    { id: uuidv4(), name: "Eggs", amount: 2, unit: "", notes: "large", position: 6 },
    { id: uuidv4(), name: "Vanilla extract", amount: 2, unit: "tsp", notes: "", position: 7 },
    { id: uuidv4(), name: "Chocolate chips", amount: 2, unit: "cup", notes: "semi-sweet", position: 8 },
  ],
  instructions: [
    { id: uuidv4(), step: 1, content: "Preheat oven to 375°F (190°C).", duration: 5, position: 0 },
    { id: uuidv4(), step: 2, content: "In a medium bowl, whisk together flour, baking soda, and salt.", duration: 2, position: 1 },
    { id: uuidv4(), step: 3, content: "In a large bowl, cream together butter and both sugars until light and fluffy.", duration: 3, position: 2 },
    { id: uuidv4(), step: 4, content: "Beat in eggs one at a time, then add vanilla extract.", duration: 2, position: 3 },
    { id: uuidv4(), step: 5, content: "Gradually mix in the flour mixture until just combined.", duration: 2, position: 4 },
    { id: uuidv4(), step: 6, content: "Fold in chocolate chips.", duration: 1, position: 5 },
    { id: uuidv4(), step: 7, content: "Drop rounded tablespoons of dough onto ungreased baking sheets.", duration: 5, position: 6 },
    { id: uuidv4(), step: 8, content: "Bake for 9-11 minutes or until golden brown around edges.", duration: 10, position: 7 },
    { id: uuidv4(), step: 9, content: "Cool on baking sheet for 2 minutes, then transfer to wire rack.", duration: 5, position: 8 },
  ],
  prepTime: 15,
  cookTime: 10,
  servings: 48,
