...
interface AdminCollaboratorManagerStandaloneProps {
  cookbookId: string;
  collaborators: CollaboratorWithUser[];
}

/**
 * Standalone admin collaborator manager component
 * This component handles everything internally and doesn't require function props
 * Safe to use in Server Components
 */
export function AdminCollaboratorManagerStandalone({ 
  cookbookId, 
  collaborators: initialCollaborators
}: AdminCollaboratorManagerStandaloneProps) {
